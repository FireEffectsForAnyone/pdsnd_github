...
def get_filters():
    ...
    while True:
        city = input("Hi! What city would you like to learn more about? Chigaco, New York City, or Washington? ")
...
def load_all_data(city, month, day):
    """
...
def main():
        while True:
            ...
            df = load_all_data(city, month, day)
